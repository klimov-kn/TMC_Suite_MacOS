// Снимок окна программы без участия человека (PlanarRT_H и PlanarRT_X).
//
...
//
//   planarrt_h_shot <файл.png> [файл задания] [ширина] [высота]
...
int main(int argc, char *argv[])
{
    ...
    const QString out = args.size() > 1 ? args.at(1)
                                        : QString::fromLatin1(TmcPlanRtApp().appName) + QStringLiteral(".png");
