...
//
//   tmc_dn_shot <файл.png> [файл задания] [ширина] [высота]
...
int main(int argc, char *argv[])
{
    ...
    const QString out = args.size() > 1 ? args.at(1) : QStringLiteral("tmc_dn.png");
    ...
    // Даём окну пройти раскладку и первую отрисовку, затем снимаем. Расчёт
    // диаграммы идёт в отдельном потоке, поэтому ждём дольше, чем в TMCROS.
