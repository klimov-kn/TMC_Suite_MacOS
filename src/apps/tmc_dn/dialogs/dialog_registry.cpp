...
#undef IDC_EDIT1
#undef IDC_EDIT2
#undef IDC_EDIT_CURDIRPAT
#undef IDC_EDIT_NUMBEMITTERS
#undef IDC_EDIT_TIMEELAPS
...
#undef IDC_GREDIT_MOD2_10
#undef IDC_GREDIT_MOD2_2
#undef IDC_GREDIT_MOD2_3
#undef IDC_GREDIT_MOD2_4
#undef IDC_GREDIT_MOD2_5
#undef IDC_GREDIT_MOD2_6
#undef IDC_GREDIT_MOD2_7
#undef IDC_GREDIT_MOD2_8
#undef IDC_GREDIT_MOD2_9
...
#undef IDC_GREDIT_OUTFLAG22
#undef IDC_GREDIT_OUTFLAG23
#undef IDC_GREDIT_OUTFLAG24
#undef IDC_GREDIT_OUTFLAG25
#undef IDC_GREDIT_OUTFLAG26
#undef IDC_GREDIT_OUTFLAG27
#undef IDC_GREDIT_OUTFLAG28
#undef IDC_GREDIT_OUTFLAG29
#undef IDC_GREDIT_OUTFLAG3
#undef IDC_GREDIT_OUTFLAG30
#undef IDC_GREDIT_OUTFLAG31
#undef IDC_GREDIT_OUTFLAG32
#undef IDC_GREDIT_OUTFLAG33
#undef IDC_GREDIT_OUTFLAG34
#undef IDC_GREDIT_OUTFLAG35
#undef IDC_GREDIT_OUTFLAG36
#undef IDC_GREDIT_OUTFLAG37
#undef IDC_GREDIT_OUTFLAG38
#undef IDC_GREDIT_OUTFLAG39
#undef IDC_GREDIT_OUTFLAG4
#undef IDC_GREDIT_OUTFLAG40
...
#undef IDD_DIALOGCALCDEVIAT
#undef IDD_DIALOGGRPARALL
#undef IDD_DIALOGMAKEDEVIAT
#undef IDD_READDATA_THREAD
#undef IDOK
#undef IDOK2
#undef IDOK3
#undef IDOK4
...
#include "ui_IDD_DIALOGMAKEDEVIAT.h"
#include "ui_IDD_DIALOGCALCDEVIAT.h"
#include "ui_IDD_READDATA_THREAD.h"
...
void tmcSetup_IDD_DIALOGMAKEDEVIAT(void* qDialog)
{
    // Ui_-объект хранит только указатели: после setupUi() виджеты
    // принадлежат диалогу, и держать его дальше не нужно.
    Ui_IDD_DIALOGMAKEDEVIAT ui;
    ui.setupUi(static_cast<QDialog*>(qDialog));
}

void tmcSetup_IDD_DIALOGCALCDEVIAT(void* qDialog)
{
    // Ui_-объект хранит только указатели: после setupUi() виджеты
    // принадлежат диалогу, и держать его дальше не нужно.
    Ui_IDD_DIALOGCALCDEVIAT ui;
    ui.setupUi(static_cast<QDialog*>(qDialog));
}

void tmcSetup_IDD_READDATA_THREAD(void* qDialog)
{
    // Ui_-объект хранит только указатели: после setupUi() виджеты
    // принадлежат диалогу, и держать его дальше не нужно.
    Ui_IDD_READDATA_THREAD ui;
    ui.setupUi(static_cast<QDialog*>(qDialog));
}
...
const TmcControlName kControlNames[] = {
    ...
    { 138, "IDD_DIALOGMAKEDEVIAT" },
    { 139, "IDD_DIALOGCALCDEVIAT" },
    { 1000, "IDC_GRPAR_XMIN" },
    { 1001, "IDC_GRPAR_XMAX" },
    { 1002, "IDC_GRPAR_YMIN" },
    { 1003, "IDC_GRPAR_YMAX" },
    ...
    { 1011, "IDC_EDIT1" },
    { 1012, "IDC_EDIT2" },
    { 1013, "IDC_EDIT_TIMEELAPS" },
    { 1014, "IDC_EDIT_CURDIRPAT" },
    { 1015, "IDC_GRPAR_DATFILENAME" },
    { 1017, "IDC_EDIT_NUMBEMITTERS" },
    { 1020, "IDC_PROGRESS1" },
    { 1021, "IDC_PROGRESS2" },
    ...
    { 1193, "IDC_GREDIT_OUTFLAG22" },
    { 1194, "IDC_GREDIT_OUTFLAG23" },
    { 1195, "IDC_GREDIT_OUTFLAG24" },
    { 1196, "IDC_GREDIT_OUTFLAG25" },
    { 1197, "IDC_GREDIT_OUTFLAG26" },
    { 1198, "IDC_GREDIT_OUTFLAG27" },
    { 1199, "IDC_GREDIT_OUTFLAG28" },
    { 1200, "IDC_GREDIT_OUTFLAG29" },
    { 1201, "IDC_GREDIT_OUTFLAG30" },
    { 1202, "IDC_GREDIT_OUTFLAG31" },
    { 1203, "IDC_GREDIT_OUTFLAG32" },
    { 1204, "IDC_GREDIT_OUTFLAG33" },
    { 1205, "IDC_GREDIT_OUTFLAG34" },
    { 1206, "IDC_GREDIT_OUTFLAG35" },
    { 1207, "IDC_GREDIT_OUTFLAG36" },
    { 1208, "IDC_GREDIT_OUTFLAG37" },
    { 1209, "IDC_GREDIT_OUTFLAG38" },
    { 1210, "IDC_GREDIT_OUTFLAG39" },
    { 1211, "IDC_GREDIT_OUTFLAG40" },
...
bool tmcInstall()
{
    ...
    MfcDialogRegistry::registerDialog(138 /* IDD_DIALOGMAKEDEVIAT */, &tmcSetup_IDD_DIALOGMAKEDEVIAT);
    MfcDialogRegistry::registerDialog(139 /* IDD_DIALOGCALCDEVIAT */, &tmcSetup_IDD_DIALOGCALCDEVIAT);
    MfcDialogRegistry::registerDialog(104 /* IDD_READDATA_THREAD */, &tmcSetup_IDD_READDATA_THREAD);
